...
const DashboardOverview = ({accounts, transactions}) => {
    ...
    //filter transaction for selected acc
    const accountTransactions = transactions.filter(
        (t)=> t.accountId === selectedAccId
    )
  ...
  console.log(Object.entries(expensesByCategory))
     ...
     <div className="grid gap-4 md:grid-cols-2">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          ...
          <Select
            value={selectedAccId}
            onValueChange={setSelectedAccId}
          >
            <SelectTrigger className="w-[140px] text-gray-400">
